...
public class TCPServer {
    ...
    /**
     * Метод принимает данные от клиента, выводит информацию о полученной команде на консоль и выполняет ее.
     * @param clientAddress адрес клиента, от которого получены данные
     * @param data объект, содержащий данные, полученные от клиента
     * @return результат выполнения команды
     * @throws RuntimeException если произошла ошибка при выполнении команды
     */
     ...
     * @param clientChannel канал, через который будет отправлен объект
    ...
    /**
     * Метод запускает сервер, принимает подключения от клиентов, читает данные от клиентов и выполняет соответствующие команды.
     * @throws RuntimeException если произошла ошибка при выполнении команды
     */
    public void Start() {
        try {
            ...
            while (isStarted && !Thread.currentThread().isInterrupted()) {
                ...
                synchronized (clientAddresses) {
                    while (keyIterator.hasNext()) {
                        ...
                        //Если ключ предназначен для подключения
                        ...
                        //Если ключ предназначен для чтения
